      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 z-20">
        <div className="text-center max-w-5xl mx-auto">
          <motion.div
            ...
            className="inline-flex items-center px-5 py-2.5 rounded-full glass mb-10"
          >
            <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse mr-3" />
            <span className="text-sm font-medium text-white/80">
              Free for every hotel, villa & Airbnb in the world
            </span>
          </motion.div>
          ...
          >
            <h1 className="text-5xl sm:text-7xl lg:text-8xl font-black leading-[1.05] mb-8 tracking-tight">
              <span className="text-white">Every Guest Deserves</span>
              <br />
              <span className="text-white">a Concierge.</span>
              <br />
          ...
          >
            AI-powered WhatsApp concierge that recommends tours, restaurants &
            experiences to your guests. <strong className="text-white">Free forever.</strong>{" "}
            You even <strong className="text-emerald-400">earn commission</strong> on every booking.
          </motion.p>
          ...
          >
            <a
              href="#pricing"
              className="group glow-button inline-flex items-center justify-center gap-3 px-10 py-5 text-lg font-bold rounded-full bg-gradient-to-r from-primary to-accent text-white transition-all duration-300 hover:scale-105 active:scale-95"
            >
              Get Your Free Concierge
          ...
          >
            {stats.map((stat, i) => (
              <motion.div
                ...
                className="text-center px-8 py-5 rounded-2xl glass-card cursor-default"
              >
